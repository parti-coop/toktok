...
ActiveRecord::Schema.define(version: 20160922234258) do
  ...
  create_table "matches", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    ...
    t.datetime "created_at",                            null: false
    t.datetime "updated_at",                            null: false
    t.index ["committee_id"], name: "index_matches_on_committee_id", using: :btree
    t.index ["project_id", "committee_id"], name: "index_matches_on_project_id_and_committee_id", unique: true, using: :btree
  ...
  create_table "redactor2_assets", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
