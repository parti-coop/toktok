module Admin
  class ProjectsController < BaseController
    ...
    def project_params
      params.require(:project).permit(:title, :body, :proposal_id, :participations_goal_count, :image, :image_cache, :summary, :proposer_description, :matching_staff_message, committee_ids: [], attachments_attributes: [ :id, :source, :source_cache, :_destroy ])
    end
