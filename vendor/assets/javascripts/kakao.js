/**
 * Kakao Javascript SDK for Kakao Open Platform Service - v1.0.55
 *
...
module.exports = (function() {
  ...
  function _loginThroughTalk(settings){
    ...
    var pollingCode = function(){
      ...
      function _isLoginWindow(){
        return _loginWindow && (_loginWindow.location.href != "about:blank");
      }
    };
